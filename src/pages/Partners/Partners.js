        ...
        <div className="slider-container flex-col min-h-screen items-center justify-center">
            ...
            <div className="hard-skills flex items-center justify-center" style={{ padding: '50px' }}>
                {Data.map((slide, index) => (
                    <div className="hability mx-4"> {/* Add spacing between images */}
                        <ScrollAnimation animateIn="fadeInUp" delay={0.13 * 1000}>
                            <img src={slide.image} alt="Partner" className="w-32 h-32 object-contain" /> {/* Adjust size here */}
                        </ScrollAnimation>
                    </div>
                ))}
            </div>
            ...
            <div className="hard-skills flex items-center justify-center" style={{ padding: '50px' }}>
                {Data.map((slide, index) => (
                    <div className="hability mx-4"> {/* Add spacing between images */}
                        <ScrollAnimation animateIn="fadeInUp" delay={0.13 * 1000}>
                            <img src={slide.image} alt="Investor" className="w-32 h-32 object-contain" /> {/* Adjust size here */}
                        </ScrollAnimation>
                    </div>
                ))}
            </div>
