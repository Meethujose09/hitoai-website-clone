        ...
        <div className="flex flex-col min-h-screen bg-[#081944] text-white">
            ...
            <div className="flex flex-col md:flex-row flex-grow">
                <div className="w-full md:w-1/2 flex flex-col justify-center text-center p-8 bg-[#081944] text-white" style={{ fontFamily: 'Playfair Display, serif' }}>
                    <h1 className="text-5xl font-bold mb-8">Aimarcom</h1>

                    <p className="text-xl leading-relaxed mb-4">
                    1. Personalization and Customer Engagement </p>
          <p className="text-xl leading-relaxed mb-4">
          2. Predictive Analytics and Insights</p>
          <p className="text-xl leading-relaxed mb-4">
          3. Automation and AI-driven Efficiency</p>

          <p className="text-xl leading-relaxed mb-4">
          4. Security and Improved Search Functionality</p>
